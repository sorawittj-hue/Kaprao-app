...
export function IconButton({
  ...
  return (
    <button
      type="button"
      className={cn(
        'inline-flex items-center justify-center rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 min-h-[44px] min-w-[44px] p-2 disabled:opacity-50 disabled:cursor-not-allowed',
        variants[variant],
        className
      )}
      aria-label={ariaLabel}
